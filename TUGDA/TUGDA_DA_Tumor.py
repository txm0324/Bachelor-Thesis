...
pdx_dataset_na = pd.read_csv('./data/Tumor_Type_PDX/tumor_type_fpkm_response_NA.csv', index_col=0)
...
X_test = pdx_dataset_na[gene_list].values
y_test = pdx_dataset_na[drugs_pdx].values

X_train_unl = pdx_dataset_na[gene_list].values
